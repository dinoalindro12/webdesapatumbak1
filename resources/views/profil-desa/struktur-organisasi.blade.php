<x-layout title="Sejarah Kepala Desa">
    <!-- Hero Section -->
    <div class="relative bg-gradient-to-br from-gray-50 to-gray-100 py-24 overflow-hidden">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-xl font-light text-gray-800">2015</h3>
                    </div>
                    <div class="text-gray-600">
                        <p>Pembangunan Puskesmas Pembantu dan penyediaan akses air bersih untuk seluruh warga desa.</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-xl font-light text-gray-800">2007</h3>
                    </div>
                    <div class="text-gray-600">
                        <p>Peresmian Balai Desa baru sebagai pusat kegiatan masyarakat dan pemerintahan desa.</p>
                    </div>
                </div>
    ...
    <!-- <div class="bg-white py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <div class="mt-4 w-20 h-px bg-gray-300 mx-auto"></div>
                <p class="mt-4 text-gray-500">Tim yang saat ini mengemban amanah memimpin Desa Sukamaju</p>
            </div>
                ...
                <div class="org-chart mx-auto">
                    ...
                    <div class="org-level-1 transform transition-all duration-700 ease-out opacity-0 translate-y-6 animate-fade-in-up">
                        <div class="org-node">
                            ...
                            <div class="org-node-content">
                                <div class="font-medium">Bapak Sutrisno</div>
                                <div class="text-sm text-gray-600">Periode 2021-2027</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="org-level-2 transform transition-all duration-700 ease-out opacity-0 translate-y-6 animate-fade-in-up" style="animation-delay: 200ms">
                        <div class="org-node">
                            ...
                            <div class="org-node-content">
                                <div class="font-medium">Bapak Joko</div>
                                <div class="text-sm text-gray-600">Penanggung Jawab Administrasi</div>
                            </div>
                        </div>

                        <div class="org-node">
                            <div class="org-node-header bg-gray-400 text-white">Kasi Pemerintahan</div>
                            <div class="org-node-content">
                                <div class="font-medium">Ibu Siti</div>
                                <div class="text-sm text-gray-600">Urusan Pemerintahan</div>
                            </div>
                        </div>

                        <div class="org-node">
                            <div class="org-node-header bg-gray-400 text-white">Kasi Kesejahteraan</div>
                            <div class="org-node-content">
                                <div class="font-medium">Bapak Ahmad</div>
                                <div class="text-sm text-gray-600">Urusan Kesejahteraan</div>
                            </div>
                        </div>

                        <div class="org-node">
                            <div class="org-node-header bg-gray-400 text-white">Kasi Pelayanan</div>
                            <div class="org-node-content">
                                <div class="font-medium">Ibu Rini</div>
                                <div class="text-sm text-gray-600">Urusan Pelayanan</div>
                            </div>
                        </div>
                    </div>
                </div>
