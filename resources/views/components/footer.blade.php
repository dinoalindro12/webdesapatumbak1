        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="space-y-4">
                ...
                <p class="text-gray-300 text-sm">
                    Desa kami berkomitmen untuk memberikan pelayanan terbaik kepada masyarakat melalui inovasi dan teknologi.
                </p>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-gray-300 hover:text-white text-sm">Surat Keterangan</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white text-sm">Administrasi KTP</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white text-sm">Pengajuan KK</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white text-sm">Pelayanan Pajak</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white text-sm">Pengaduan Masyarakat</a></li>
                </ul>
            </div>
            ...
            <div class="space-y-4">
                ...
                <address class="not-italic text-gray-300 text-sm">
                    <div class="flex items-start mb-3">
                        ...
                        <span>Jl. Raya Desa No. 123, Kecamatan Contoh, Kabupaten Deli Serdang, Provinsi Sumatera Utara</span>
                    </div>
        ...
        <div class="mt-12 border-t border-gray-700 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm text-center md:text-left">
                    &copy; 2023 Desa Digital. All rights reserved.
                </p>
