                    ...
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                        ...
                        <div class="px-6 py-4">
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <tbody>
                                        ...
                                        <!-- <tr>
                                            <td class="px-6 py-3 font-semibold text-gray-600 dark:text-gray-200">Nomor
                                                HP</td>
                                        ...
                                        <tr>
                                            <td class="px-6 py-3 font-semibold text-gray-600 dark:text-gray-200">Tanggal
                                                Buat</td>
                                            <td class="px-6 py-3">{{ $surat->tanggal_buat ? $surat->tanggal_buat->format('d-m-Y') : '-' }}</td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="flex flex-col md:flex-row gap-3 pt-6">
                                ...
                                <div>
                                    <a href="{{ route('surat-menyurat.print', $surat->id) }}"
                                        class="bg-slate-600 hover:bg-slate-700 focus:ring-4 focus:outline-none focus:ring-slate-300 rounded-md px-3 py-2 transition duration-200 text-white">Buat</a>
                                </div>
                            </div>
                        </div>
                    </div>
