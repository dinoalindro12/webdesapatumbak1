    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="{{ route('galeri.update', $galeri->id) }}" method="POST" enctype="multipart/form-data" class="bg-white shadow rounded-lg p-6 space-y-6">
            ...
            <div>
                ...
                <input type="url" name="link_video" id="link_video" value="{{ old('link_video', $galeri->link_video) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-gray-500 focus:border-gray-500">
                @error('link_video')
