                ...
                <div class="px-6 py-5 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="keberhasilan" class="block text-sm font-medium text-gray-700">keberhasilan Desa</label>
                                <input type="text" name="keberhasilan" id="keberhasilan" 
                                       value="{{ old('keberhasilan') }}" 
                                       class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-sm"
                                       maxlength="255">
                            </div>
